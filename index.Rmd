...
In psychometrics conducting item analysis is very common. **psych** packages have provided enough tools to smoothly run the item analysis. Here we will create publication friendly summary table of item analysis with all necessary information using function **des.tab()**
